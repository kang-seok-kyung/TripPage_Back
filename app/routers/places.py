...
def chat_with_ai(req: schemas.ChatRequest, db: Session = Depends(get_db)):
    ...
    try:
        ...
        analysis_prompt = (
            ...
            "응답 포맷 (JSON Only):\n"
            "{\n"
            "  \"region\": \"대구\" 또는 \"구미\" 또는 \"칠곡\" 또는 \"성주\" 또는 \"고령\" (질문에 명확한 지역이 없으면 null),\n"
            "  \"district\": \"남구\" 또는 \"중구\" 또는 \"동구\" 또는 \"서구\" 또는 \"북구\" 또는 \"수성구\" 또는 \"달서구\" 또는 \"달성군\" 또는 \"군위군\" 또는 \"선산읍\" (없으면 null),\n"
            "  \"content_type\": \"음식점\" 또는 \"관광지\" 또는 \"문화시설\" 또는 \"축제공연행사\"또는 \"여행코스\" 또는 \"레포츠\" 또는 \"숙박\" 또는 \"쇼핑\" (질문과 무관하거나 없으면 null),\n"
